...
const DISTRICTS = [
  { id: 'Bhopal', name: 'Bhopal', nameAs: 'भोपाल', nameHi: 'भोपाल' },
  { id: 'Indore', name: 'Indore', nameAs: 'इंदौर', nameHi: 'इंदौर' },
  { id: 'Ujjain', name: 'Ujjain', nameAs: 'उज्जैन', nameHi: 'उज्जैन' },
  { id: 'Gwalior', name: 'Gwalior', nameAs: 'ग्वालियर', nameHi: 'ग्वालियर' },
  { id: 'Jabalpur', name: 'Jabalpur', nameAs: 'जबलपुर', nameHi: 'जबलपुर' },
  { id: 'Sagar', name: 'Sagar', nameAs: 'सागर', nameHi: 'सागर' },
  { id: 'Rewa', name: 'Rewa', nameAs: 'रीवा', nameHi: 'रीवा' },
  { id: 'Satna', name: 'Satna', nameAs: 'सतना', nameHi: 'सतना' }
];
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ vendors, setVendors, onBackToHome }) => {
  ...
  const [selectedHeatmapDistrict, setSelectedHeatmapDistrict] = useState<string>('Bhopal');
  ...
  const filteredVendors = vendors.filter(v => {
    ...
    const matchesDistrict = 
      ...
      (selectedDistrict === 'Bhopal' && (v.location?.address || '').toLowerCase().includes('bhopal'));
   ...
   const mobileCartCount = vendors.filter(v => v.businessType.includes('ठेला') || v.businessType.includes('ঠেলা গাড়ী') || v.businessType.includes('Mobile') || v.vendingType === 'mobile').length;
   const fixedShopCount = vendors.filter(v => v.businessType.includes('स्थायी') || v.businessType.includes('স্থায়ী') || v.businessType.includes('Fixed') || v.vendingType === 'fixed').length;
   const seasonalCount = vendors.filter(v => v.businessType.includes('ऋतु') || v.businessType.includes('ঋতুভিত্তিক') || v.businessType.includes('Seasonal') || v.vendingType === 'seasonal').length;
   const msmeCount = vendors.filter(v => v.businessType.includes('लघु') || v.businessType.includes('ক্ষুদ্ৰ') || v.businessType.includes('MSME')).length;
   ...
   const womenOwnedCount = vendors.filter(v => 
     v.name.includes("सुनीता") || v.name.includes("पूजा") || v.name.includes("रेखा") ||
     v.name.includes("राधा") || v.name.includes("किरण") || v.name.includes("प्रीति") ||
     ...
     v.name.toLowerCase().includes("sunita") || v.name.toLowerCase().includes("pooja") ||
     v.name.toLowerCase().includes("rekha") || v.name.toLowerCase().includes("radha") ||
     v.name.toLowerCase().includes("kiran") || v.name.toLowerCase().includes("preeti") ||
   ...
   const tourismImpactCount = vendors.filter(v => 
     v.profession.includes("हस्तशिल्प") || v.profession.includes("हथकरघा") || v.profession.includes("बुनकर") ||
     v.profession.includes("फूल") || v.profession.includes("কুটিৰ") || v.profession.includes("বয়ন") ||
     ...
     v.location.address.includes("Ujjain") || v.location.address.includes("Bhopal") ||
     v.location.address.includes("Indore")
   ).length;
   ...
   const getSubmissionsByDistrict = (distId: string) => {
     return vendors.filter(v => 
       ...
       (distId === 'Bhopal' && (v.location?.address || '').toLowerCase().includes('bhopal'))
     ).length;
   };
 
   // Find topmost active district leader
   let leaderDistrictName = "Bhopal";
   let maxCount = 0;
   DISTRICTS.forEach(d => {
        ...
        <div className="max-w-md mx-auto my-12 md:my-20">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-gray-500 font-bold uppercase tracking-wider">
              {t('मध्य प्रदेश सरकार प्रशासनिक पहुंच', 'Madhya Pradesh Government Administrative Access', 'मध्य प्रदेश सरकार प्रशासनिक पहुंच')}
            </p>
          </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="flex items-center space-x-2.5">
                    <span className="text-[10px] font-black uppercase tracking-widest text-amber-400 font-mono">MP DECOS Pulse</span>
                  ...
                  <h3 className="text-sm font-black text-white/90 tracking-tight mt-0.5">
                    {t('मध्य प्रदेश डिजिटल आर्थिक कमान केंद्र', 'MP Digital Economic Command Center', 'मध्य प्रदेश डिजिटल आर्थिक कमान केंद्र')}
                  </h3>
                </div>
              </div>
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-gray-200/60">
            <div>
              ...
              <h1 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tighter leading-none">
                {t('मध्य प्रदेश डिजिटल आर्थिक कमान केंद्र', 'Madhya Pradesh Digital Economic Operating System (DECOS)', 'मध्य प्रदेश डिजिटल आर्थिक कमान केंद्र')}
              </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 md:p-8 rounded-[32px] border border-gray-100 shadow-sm flex flex-col justify-between relative overflow-hidden group">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-400 font-extrabold uppercase tracking-wide">
                      {t('প্ৰত্যক্ষ আৰ্থিক সাহাৰ্য্য আৰু ঋন:', 'Direct Capital & Loan Leverage:')} <span className="text-emerald-600 font-black">₹{((creditEnabledAmount) / 100000).toFixed(2)} Lakh</span>
                    </p>
                  </div>
                  <div className="mt-5 pt-3.5 border-t border-gray-50 flex items-center justify-between text-[10px] font-black uppercase text-gray-500">
                    <span>{t('প্ৰতিষ্ঠানিক ঋণ সংযোগ', 'Institutional credit connectivity')}</span>
                    <span className="text-emerald-600 bg-emerald-50 px-2 rounded font-bold">ACTIVE</span>
                  </div>
                </div>

                {/* CARD 4: WOMEN-OWNED LEADERSHIP */}
                <div className="bg-white p-6 md:p-8 rounded-[32px] border border-gray-100 shadow-sm flex flex-col justify-between relative overflow-hidden group">
                  ...
                  <div>
                    <div className="flex items-center space-x-2 text-[9px] font-black text-purple-600 uppercase tracking-widest leading-none mb-3">
                      ...
                      <span>{t('মহিলা উদ্যোগ সবলীকৰণ', 'Women-owned Leadership', 'महिला उद्यम')}</span>
                    </div>
                    <p className="text-4xl font-extrabold text-gray-900 tracking-tight leading-none mb-1.5">
                      {womenOwnedCount} {t('ব্যৱসায়ী', 'Nodes')}
                    </p>
                    <p className="text-[10px] text-gray-400 font-extrabold uppercase tracking-wide">
                      {t('পঞ্জীভূক্ত মহিলা কৰ্মী', 'Registered Women Business Nodes', 'महिला उद्यमी')}
                    </p>
                  </div>
                  <div className="mt-5 pt-3.5 border-t border-gray-50 flex items-center justify-between text-[10px] font-black uppercase text-gray-500">
                ...
                <div className="bg-white p-6 md:p-8 rounded-[32px] border border-gray-100 shadow-sm flex flex-col justify-between relative overflow-hidden group">
                  ...
                  <div>
                    <div className="flex items-center space-x-2 text-[9px] font-black text-sky-600 uppercase tracking-widest leading-none mb-3">
                      ...
                      <span>{t('পৰ্যটন আৰু সংস্কৃতি', 'Tourism & Cultural Nodes', 'पर्यटन एवं संस्कृति Cluster')}</span>
                    </div>
                    <p className="text-4xl font-extrabold text-gray-900 tracking-tight leading-none mb-1.5">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-50 pb-4">
                      <div>
                        ...
                        <h2 className="text-2xl font-black text-gray-900 tracking-tighter mt-3 leading-snug">
                          {t('मध्य प्रदेश जिला-वार आर्थिक हीटमैप', 'Madhya Pradesh District-Wise Economic Heatmap Console', 'मध्य प्रदेश जिला-वार आर्थिक हीटमैप')}
                        </h2>
                          ...
                          >
                            <div>
                              <p className={`text-[8px] font-black uppercase tracking-widest leading-none ${isSelected ? 'text-amber-100' : 'text-gray-400'}`}>
                                {d.id === 'Bhopal' ? 'Capital-Hub' : d.id === 'Indore' ? 'Commercial-Hub' : 'District'}
                              </p>
                  ...
                  <div className="p-6 bg-gray-50 rounded-[30px] border border-gray-100 grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div>
                      <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest leading-none mb-2">
                        {t('জিলা পঞ্জীয়ন পদাৰ্পণ', 'Territorial Registries', 'क्षेत्रीय रजिस्ट्रियां')}
                      </p>
                      <h4 className="text-lg font-black text-gray-900 leading-tight">
                        {lang === 'hi' ? DISTRICTS.find(d => d.id === selectedHeatmapDistrict)?.nameHi : selectedHeatmapDistrict}
                      </h4>
                      <p className="text-xs text-gray-500 font-bold mt-1">
                        {t('অসম চৰকাৰ ম্যাপ্ড কৰা নোড', 'Official public nodes mapped.', 'आधिकारिक नोड्स मानचित्रित।')}
                      </p>
                    </div>
                ...
                <div className="bg-gradient-to-br from-gray-900 via-gray-950 to-amber-950/80 p-8 rounded-[40px] border border-amber-950/40 text-white shadow-xl flex flex-col justify-between space-y-8 relative overflow-hidden">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-4.5 bg-white/5 hover:bg-white/8 rounded-2xl border border-white/10 transition-colors space-y-1.5">
                      <div className="flex items-center space-x-2">
                        ...
                        <h4 className="text-xs font-black uppercase tracking-wide text-amber-300">
                          {t('হস্তশিল্প আৰু তাঁত শিল্প সংস্থাপন', 'Sustained Chanderi & Maheshwari Craft Cluster', 'हस्तशिल्प और हथकरघा क्लस्टर विकास')}
                        </h4>
                      </div>
                      <p className="text-[11px] text-gray-300 leading-normal">
                        Chanderi and Maheshwar weaving operators hold a high transaction velocity of ₹36,000/mo. Activating specialized handloom incentives can double regional export value.
                      </p>
                    </div>
                    ...
                    <div className="p-4.5 bg-white/5 hover:bg-white/8 rounded-2xl border border-white/10 transition-colors space-y-1.5">
                      <div className="flex items-center space-x-2">
                        ...
                        <h4 className="text-xs font-black uppercase tracking-wide text-blue-300">
                          {t('পৌৰ সংস্থাপন আনুষ্ঠানিকীকৰণ', 'Bhopal & Indore Municipal Formalization', 'नगर निगम व्यवस्था औपचारिकता')}
                        </h4>
                      </div>
                      <p className="text-[11px] text-gray-300 leading-normal">
                        Bhopal and Indore street food nodes represent 34% of local informal sector jobs. Formalizing municipal clusters is highly recommended.
                      </p>
                    </div>
                    ...
                    <div className="p-4.5 bg-white/5 hover:bg-white/8 rounded-2xl border border-white/10 transition-colors space-y-1.5">
                      ...
                      <p className="text-[11px] text-gray-300 leading-normal">
                        Madhya Pradesh state credit trust repayment rating sits at 98.4%. Standardizing local collateral-free credit will inject essential capital directly into rural GDP.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white p-6 md:p-8 rounded-[40px] border border-gray-100 shadow-sm space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="p-5.5 bg-gray-50 border border-gray-100 rounded-3xl shrink-0 space-y-2">
                    ...
                    <p className="text-[10px] text-gray-500 font-bold leading-normal">
                      Expanded rural integration over Malwa, Bundelkhand and Narmada valleys.
                    </p>
                  </div>
                  ...
                  <div className="p-5.5 bg-indigo-50/50 border border-indigo-100 rounded-3xl shrink-0 space-y-2">
                    ...
                    <p className="text-[10px] text-indigo-800 font-bold leading-normal">
                      Full-state compliance under MP Street Vendor Act.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 md:p-8 rounded-[40px] border border-blue-100/60 shadow-inner grid grid-cols-1 md:grid-cols-4 gap-6 items-center">
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-medium mt-1 leading-relaxed">
                    Under MP Street Vendor Registration SLA directives. Verified percentage and queues are calculated dynamically.
                  </p>
                </div>
                      ...
                      {filteredVendors.length === 0 ? (
                        ...
                        filteredVendors.map((vendor) => (
                          ...
                          >
                            ...
                            <td className="py-5.5 px-6">
                              <div className="flex items-center space-x-2">
                                {vendor.businessType.includes('ठेला') || vendor.businessType.includes('ঠেলা গাড়ী') || vendor.vendingType === 'mobile' ? (
                                  <Truck className="w-4 h-4 text-orange-600/70" />
                                ) : vendor.businessType.includes('स्थायी') || vendor.businessType.includes('স্থায়ী') || vendor.vendingType === 'fixed' ? (
                                  <Store className="w-4 h-4 text-blue-600/70" />
                                ) : vendor.businessType.includes('ऋतु') || vendor.businessType.includes('ঋতুভিত্তিক') || vendor.vendingType === 'seasonal' ? (
                            ...
                            <td className="py-5.5 px-6">
                              <span className="text-xs font-black bg-gray-100 text-gray-800 px-3 py-1.5 rounded-lg border border-gray-200">
                                {vendor.profession || t('सामान्य व्यापार (General Trade)', 'General Trade', 'सामान्य व्यापार (General Trade)')}
                              </span>
                            </td>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm lg:col-span-2 space-y-6">
                  <div>
                    ...
                    <h2 className="text-2xl font-black text-gray-900 tracking-tighter mt-3">
                      MP Electronic Public Trust & Fraud Intelligence Desk
                    </h2>
                    <p className="text-gray-500 text-sm font-medium mt-1">
                ...
                <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm space-y-6">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 font-medium mt-1">
                      Madhya Pradesh Digital Public Trust Scores. Based on municipal rating indices and on-time credit repayment behaviors.
                    </p>
                  </div>
                ...
                <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm space-y-6">
                  <div>
                    <span className="text-[10px] font-black text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-100 uppercase tracking-widest leading-none">
                      Dignified MP Business QR Badge Ecosystem
                    </span>
                    <h2 className="text-2xl font-black text-gray-900 tracking-tighter mt-3">
                ...
                <div className="bg-gradient-to-tr from-emerald-50 via-teal-50/40 to-white p-8 rounded-[40px] border-4 border-emerald-600 shadow-xl flex flex-col justify-between items-center text-center relative overflow-hidden group">
                  ...
                  <div className="space-y-1.5 w-full">
                    <span className="text-[9px] uppercase font-black tracking-widest text-emerald-800 bg-emerald-100 px-3 py-1 rounded-full border border-emerald-200">
                      GOVERNMENT OF MADHYA PRADESH • OFFICIAL VERIFICATION
                    </span>
                    ...
                    <p className="text-[8px] font-mono font-bold text-gray-400 uppercase tracking-widest">
                      Under MP Street Vendor Livelihood Act, 2026
                    </p>
                  </div>
                  ...
                  <div className="py-6 space-y-4 w-full">
                    ...
                    <div>
                      <h3 className="text-lg font-black text-gray-900 leading-none">
                        {vendors.find(v => v.id === (activeQRVendorId || vendors[0]?.id))?.name || 'Madhya Pradesh Vendor'}
                      </h3>
                      <p className="text-[10px] font-mono font-black text-emerald-700 tracking-widest mt-1.5 uppercase">
                        UID: {vendors.find(v => v.id === (activeQRVendorId || vendors[0]?.id))?.id || 'MP-PENDING'}
                      </p>
                      <p className="text-xs text-gray-500 font-bold mt-1">
                        Registered District: <span className="text-gray-900 font-extrabold">{vendors.find(v => v.id === (activeQRVendorId || vendors[0]?.id))?.location.address.split(',').slice(-1)[0] || 'Bhopal'}</span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm space-y-6">
                  ...
                  <div className="space-y-3 max-h-[290px] overflow-y-auto pr-1">
                    ...
                    <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 flex items-center justify-between">
                      <div>
                        <h4 className="text-xs font-black text-gray-950">Maheshwari Handloom Weaving</h4>
                        <p className="text-[10px] text-gray-400 font-bold">Khargone Maheshwar Craft District • Narmada Handlooms</p>
                      </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 flex items-center justify-between">
                      <div>
                        <h4 className="text-xs font-black text-gray-950">Chanderi Handloom Sarees</h4>
                        <p className="text-[10px] text-gray-400 font-bold">Chanderi Craft District • Malvi Weaves</p>
                      </div>
                      <span className="bg-emerald-50 text-emerald-700 border border-emerald-100 rounded-lg px-2.5 py-1.5 text-[10px] font-sans font-black">
                        ★ 4.8 Rating
                      </span>
                    ...
                    <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 flex items-center justify-between">
                      <div>
                        <h4 className="text-xs font-black text-gray-950">Bhopali Special Poha & Chai</h4>
                        <p className="text-[10px] text-gray-400 font-bold">Bhopal District • Raja Bhoj Snacks</p>
                      </div>
                      <span className="bg-emerald-50 text-emerald-700 border border-emerald-100 rounded-lg px-2.5 py-1.5 text-[10px] font-sans font-black">
                        ★ 4.7 Rating
                      </span>
