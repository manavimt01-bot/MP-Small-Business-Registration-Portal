...
const Home: React.FC<HomeProps> = ({ onStart, onViewDashboard }) => {
  ...
  const visionPillars = [
    { text: t('প্ৰশাসনিক শক্তি', 'Administrative strength', 'प्रशासनिक शक्ति'), icon: <Shield className="w-3 h-3" /> },
    { text: t('ব্যৱসায় কৰাৰ সহজ পদ্ধতি', 'Ease of doing business', 'व्यापार सुगमता'), icon: <Cpu className="w-3 h-3" /> },
    { text: t('বিক্ৰেতাসকলৰ সন্মান', 'Respect for vendors', 'विक्रेताओं का सम्मान'), icon: <Scale className="w-3 h-3" /> },
    { text: t('ডিজিটেল সুশাসন', 'Digital governance', 'डिजिटल सुशासन'), icon: <Globe className="w-3 h-3" /> }
  ];

  const testimonials = [
    {
      name: t("राजेन्द्र राठौर", "Rajendra Rathore", "राजेन्द्र राठौर"),
      type: t("फल विक्रेता, भोपाल", "Fruit Vendor, Bhopal", "फल विक्रेता, भोपाल"),
      text: t("पहले दुकान हटाने का हमेशा डर रहता था, लेकिन अब यह डिजिटल पहचान पत्र ही मेरी सबसे बड़ी सुरक्षा है।", "Earlier there was fear of eviction, but now this digital ID card is my greatest security.", "पहले दुकान हटाने का हमेशा डर रहता था, लेकिन अब यह डिजिटल पहचान पत्र ही मेरी सबसे बड़ी सुरक्षा है।"),
      image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=200&h=200",
      rating: 5
    },
    {
      name: t("पुष्पा साहू", "Pushpa Sahu", "पुष्पा साहू"),
      type: t("महिला उद्यमी, इंदौर", "Woman Entrepreneur, Indore", "महिला उद्यमी, इंदौर"),
      text: t("बिना किसी दलाल या रिश्वत के मेरा पंजीकरण हो गया और अब मुझे बैंक से बिना गारंटी के ऋण प्राप्त हो चुका है।", "My registration was completed without any middleman or bribe, and now I have received a collateral-free bank loan.", "बिना किसी दलाल या रिश्वत के मेरा पंजीकरण हो गया और अब मुझे बैंक से बिना गारंटी के ऋण प्राप्त हो चुका है।"),
    ...
    <div className="animate-in fade-in duration-700">
            ...
            <div className="lg:col-span-7 z-10">
              <div className="flex flex-wrap gap-4 mb-10">
                <div className="inline-flex items-center space-x-3 bg-orange-50 text-orange-700 px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest border border-orange-100 shadow-sm">
                  ...
                  <span>{t('मध्य प्रदेश सरकार की पहल', 'MP Government Initiative', 'मध्य प्रदेश सरकार की पहल')}</span>
                </div>
                <div className="bg-white px-6 py-2.5 rounded-full shadow-md border border-orange-50 flex items-center space-x-4">
                  ...
                  <p className="text-[8px] font-black text-gray-400 uppercase tracking-[0.2em] leading-tight">{t('সশক্ত ক্ষুদ্ৰ ব্যৱসায়', 'Small Businesses Empowered', 'सशक्त लघु व्यवसाय')}</p>
                </div>
              </div>

              <h1 className="text-6xl md:text-8xl font-black text-gray-900 leading-[0.95] mb-10 tracking-tighter">
                {t('सशक्त विक्रेता,', 'Empowered Vendor,', 'सशक्त विक्रेता,')} <br />
                <span className="text-orange-600">{t('समृद्ध मध्य प्रदेश।', 'Empowered Madhya Pradesh.', 'समृद्ध मध्य प्रदेश।')}</span>
              </h1>
              
              <p className="text-2xl text-gray-600 mb-12 leading-relaxed max-w-2xl font-medium opacity-90">
                {t(
                  'मुख्यमंत्री डॉ. मोहन यादव के संकल्प के साथ, पथ विक्रेताओं के सम्मान और समृद्धि के लिए। अपनी डिजिटल पहचान बनाएं और योजनाओं का सीधा लाभ पाएं।',
                  "In line with CM Dr. Mohan Yadav's vision, for the dignity and prosperity of street vendors. Create your digital identity and get direct scheme benefits.",
                  'मुख्यमंत्री डॉ. मोहन यादव के संकल्प के साथ, पथ विक्रेताओं के सम्मान और समृद्धि के लिए। अपनी डिजिटल पहचान बनाएं और योजनाओं का सीधा लाभ पाएं।'
                )}
              </p>
              ...
              <div className="mb-14">
                <div className="inline-block bg-gray-900/5 px-8 py-5 rounded-[40px] border border-gray-100 backdrop-blur-sm">
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-orange-600 mb-4 border-b border-orange-100 pb-2">{t('অভিযানৰ নীতিসমূহ', 'Mission Principles', 'मिशन सिद्धांत')}</p>
              ...
              <div className="flex flex-col sm:flex-row space-y-5 sm:space-y-0 sm:space-x-8">
                ...
                >
                  {t('পঞ্জীয়ন আৰম্ভ কৰক', 'Start Registration', 'पंजीकरण शुरू करें')}
                ...
                >
                  {t('ড্যাশবৰ্ড', 'Dashboard', 'डैशबोर्ड')}
                </button>
              </div>
            </div>
              ...
              <div className="relative z-10 w-full max-w-[400px] lg:max-w-none animate-in slide-in-from-right-16 duration-1000">
                <div className="relative overflow-hidden rounded-[72px] border-[14px] border-white shadow-[0_48px_96px_-24px_rgba(0,0,0,0.18)] aspect-[4/5] bg-gradient-to-br from-orange-500 to-orange-700 group">
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-10 bg-gradient-to-t from-black/95 via-black/40 to-transparent text-white">
                    <p className="text-[10px] font-black tracking-[0.5em] uppercase opacity-80 mb-3">{t('माननीय मुख्यमंत्री', "Hon'ble Chief Minister", 'माननीय मुख्यमंत्री')}</p>
                    <h3 className="text-4xl font-black tracking-tighter leading-none mb-4">Dr. Mohan Yadav</h3>
                ...
                <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-2xl p-6 px-8 rounded-[36px] shadow-2xl border border-white/60 z-20 flex items-center space-x-6 min-w-[280px]">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">{t('विक्रेता कल्याण में', 'In Vendor Welfare', 'विक्रेता कल्याण में')}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-24">
            <div className="inline-flex items-center space-x-3 bg-blue-50 text-blue-700 px-6 py-2.5 rounded-full text-[10px] font-black uppercase tracking-widest mb-8 border border-blue-100 shadow-sm">
              ...
              <span>{t('বিত্তীয় সাহায্য আঁচনিসমূহ', 'Financial Assistance Schemes', 'वित्तीय सहायता योजनाएं')}</span>
            </div>
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 tracking-tighter">
              {t('मध्य प्रदेश की कल्याणकारी योजनाएं', 'Welfare Schemes of Madhya Pradesh', 'मध्य प्रदेश की कल्याणकारी योजनाएं')}
            </h2>
          </div>
            ...
            {SCHEMES.map((scheme) => (
              <div key={scheme.id} className="bg-gray-50/50 p-12 rounded-[64px] border border-gray-100 hover:bg-white hover:shadow-2xl hover:shadow-orange-100/30 hover:border-orange-100 transition-all duration-500 group">
                ...
                <h3 className="text-3xl font-black text-gray-900 mb-6 leading-tight">
                  {lang === 'hi' ? scheme.titleAs : scheme.title}
                </h3>
                <p className="text-gray-500 leading-relaxed font-medium mb-12 flex-grow text-lg">
                  {lang === 'hi' ? scheme.descriptionAs : scheme.description}
                </p>
                <button 
                  onClick={onStart}
                ...
                >
                  {t('এতিয়াই আবেদন কৰক', 'Apply Now', 'अभी आवेदन करें')} <ArrowRight className="ml-3 w-5 h-5" />
                </button>
              </div>
            ))}
          </div>
      ...
      <section className="bg-orange-50/30 py-40 px-4">
        <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 tracking-tighter mb-20">{t('विक्रेताओं का विश्वास', 'Vendors Trust', 'विक्रेताओं का विश्वास')}</h2>
