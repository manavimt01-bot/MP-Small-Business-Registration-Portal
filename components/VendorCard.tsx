          ...
          <div className="relative z-10 space-y-2">
            <div className="flex items-center space-x-3 mb-1">
              <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-xl border border-white/30 shadow-lg">
                 <span className="text-xs font-black">MP</span>
              </div>
              <div>
            ...
            <p className="text-[9px] opacity-75 uppercase font-black tracking-widest">{t('मध्य प्रदेश शासन', 'Govt of Madhya Pradesh', 'मध्य प्रदेश शासन')}</p>
          </div>
        ...
        <div className="p-10 pt-6 space-y-8">
          <div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">{t('मध्य प्रदेश व्यापारी पहचान', 'MP Merchant ID', 'मध्य प्रदेश व्यापारी पहचान')}</span>
            </div>
          </div>
